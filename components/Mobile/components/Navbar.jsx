    ...
    return(
        <div className=' h-full'>
             <div className = 'flex flex-col relative h-[100px] w-[328px]  bg-[#00a884] justify-between text-white p-2 pb-0'>
                ...
                <div className='flex justify-between'>
                    <button className='border-b-[3px] border-white w-full m-2'>FRIENDS</button>   
                    <button className='w-full m-2'>FAMILY</button>
                    <button className='w-full m-2'>COLLEAGUES</button>
                </div>     
            </div>
