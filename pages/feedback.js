  ...
  return (
      <div >
        ...
        <div className='absolute top-[8vh] left-[50vw] md:top-[5vh] translate-x-[-50%] flex-col z-2 w-[100vw] h-[90vh] md:w-[50vw] bg-white shadow-2xl p-2 rounded-lg'>
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSde184ykD6hKNKw6iTnoR5cqsiB2xeId7gUSVVtAEZHh5J28Q/viewform?embedded=true" width="100%" height="100%">Loading…</iframe>
        </div>
      </div>
  )
}